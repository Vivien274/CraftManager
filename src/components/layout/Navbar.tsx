      ...
      <header className="sticky top-0 z-40 w-full glass-panel border-b border-slate-200/80 px-4 lg:px-8 py-3 bg-white/95 backdrop-blur-md">
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="hidden md:flex items-center text-xs text-slate-500 pl-4 border-l border-slate-200 space-x-2">
          ...
          {/* Right Actions: Didacticiel, Auth Profile & POS Button */}
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            {user ? (
              <div className="flex items-center gap-2">
                <div className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 bg-slate-100 rounded-xl text-xs font-bold text-slate-800 border border-slate-200">
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden mt-3 pt-3 border-t border-slate-200 space-y-2 animate-in slide-in-from-top-2 duration-200">
          ...
          <div className="pt-2 border-t border-slate-200">
            <div className="w-full flex items-center justify-between p-3 rounded-xl bg-amber-50 border border-amber-200 text-amber-900 font-bold text-xs">
              <div className="flex items-center gap-2">
                <Store className="w-4 h-4 text-amber-600" />
                <span>Atelier: {organisation.name || "L'Atelier des Restanques"}</span>
              </div>
              <span className="px-2 py-0.5 bg-amber-200 rounded text-[11px]">
                🧼 Savonnerie
              </span>
            </div>
          </div>
